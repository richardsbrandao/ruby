...
class VacanciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacancy" do
    assert_difference('Vacancy.count') do
      post vacancies_url, params: { vacancy: { company_id: @vacancy.company_id, position: @vacancy.position, salary: @vacancy.salary } }
    end
  ...
  test "should update vacancy" do
    patch vacancy_url(@vacancy), params: { vacancy: { company_id: @vacancy.company_id, position: @vacancy.position, salary: @vacancy.salary } }
